  ...
  if (vista === "lista") return (
    <div style={{ display:"flex", flexDirection:"column", height:"100%", minHeight:0 }}>
      ...
      <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", marginBottom:22, flexShrink:0, flexWrap:"wrap", gap:12 }}>
        <div>
          <h1 style={{ fontFamily:"'DM Sans',sans-serif", fontSize:32, fontWeight:900, color:C.textPrimary, margin:"0 0 4px" }}>
            Gestión de Usuarios
          </h1>
          ...
          <div style={{ background:"#111111", border:"1px solid rgba(255,255,255,0.08)", borderRadius:14, maxWidth:380, width:"100%", padding:"26px" }}>
            ...
            <div style={{ display:"flex", gap:10 }}>
              <button onClick={()=>setConfirmDel(null)}
                style={{ flex:1, padding:"10px", borderRadius:8, border:"1px solid rgba(255,255,255,0.1)", background:"transparent", color:C.textPrimary, fontFamily:"'DM Sans',sans-serif", fontSize:14, fontWeight:600, cursor:"pointer" }}
              ...
              <button onClick={()=>eliminar(confirmDel.id)}
                style={{ flex:1, padding:"10px", borderRadius:8, border:"none", background:"#ef4444", color:"#fff", fontFamily:"'DM Sans',sans-serif", fontSize:14, fontWeight:700, cursor:"pointer" }}
                onMouseEnter={e=>e.currentTarget.style.background="#dc2626"}
                onMouseLeave={e=>e.currentTarget.style.background="#ef4444"}>Eliminar</button>
            </div>
          </div>
        </div>
      )}
  ...
  return (
    <div style={{ display:"flex", flexDirection:"column", height:"100%", minHeight:0 }}>
      ...
      <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", marginBottom:20, flexShrink:0, flexWrap:"wrap", gap:12 }}>
        <div>
          <h1 style={{ fontFamily:"'DM Sans',sans-serif", fontSize:32, fontWeight:900, color:C.textPrimary, margin:"0 0 4px" }}>Gestión de Usuarios</h1>
          <p style={{ fontSize:13, color:C.textSec, margin:0, fontFamily:"'DM Sans',sans-serif" }}>
            {usuarios.length} {usuarios.length===1?"usuario registrado":"usuarios registrados"}
          </p>
        </div>
      ...
      <div style={{ flex:1, display:"grid", gridTemplateColumns:"1fr 300px", gap:16, minHeight:0, overflow:"hidden" }}>
        ...
        {/* Formulario */}
        <div style={{ background:"#111111", border:"1px solid rgba(255,255,255,0.08)", borderRadius:14, padding:"24px 26px", display:"flex", flexDirection:"column", overflowY:"auto" }}>
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:14, flex:1 }}>
            ...
            <div>
              ...
              <input type="text" placeholder="ej: juan.perez" value={form.username}
                ...
                onBlur={e=>e.target.style.borderColor=errs.username?"#ef4444":"rgba(255,255,255,0.09)"} />
            ...
            <div>
              ...
              <input type="text" placeholder="ej: Juan Pérez" value={form.nombre}
                ...
                onFocus={e=>e.target.style.borderColor="#FF6B00"}
                onBlur={e=>e.target.style.borderColor=errs.nombre?"#ef4444":"rgba(255,255,255,0.09)"} />
              ...
              <div>
                ...
                <div style={{ position:"relative" }}>
                  <input type={showP1?"text":"password"} placeholder="Mínimo 6 caracteres" value={form.password}
                    ...
                    onFocus={e=>e.target.style.borderColor="#FF6B00"}
                    onBlur={e=>e.target.style.borderColor=errs.password?"#ef4444":"rgba(255,255,255,0.09)"} />
              ...
              <div>
                ...
                <div style={{ position:"relative" }}>
                  <input type={showP2?"text":"password"} placeholder="Repite la contraseña" value={form.confirmar}
                    ...
                    onFocus={e=>e.target.style.borderColor="#FF6B00"}
                    onBlur={e=>e.target.style.borderColor=errs.confirmar?"#ef4444":"rgba(255,255,255,0.09)"} />
          ...
          <div style={{ background:"#111111", border:"1px solid rgba(255,255,255,0.08)", borderRadius:14, padding:"20px", flex:1 }}>
            ...
            {[
              ...
              <div key={row.l} style={{ display:"flex", justifyContent:"space-between", alignItems:"center", padding:"8px 0", borderBottom:i<arr.length-1?"1px solid rgba(255,255,255,0.05)":"none" }}>
                ...
                <span style={{ fontSize:13, color:row.v==="—"?C.textGhost:C.textPrimary, fontWeight:600, fontFamily:"'DM Sans',sans-serif" }}>{row.v}</span>
              </div>
            ))}
          </div>
      ...
      <style>{`::placeholder{color:rgba(255,255,255,0.18)!important;} select option{background:#111;color:#f0f4f8;}`}</style>
    </div>
  );
}