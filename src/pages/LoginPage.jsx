...
export default function LoginPage() {
  ...
  return (
    <div style={{
      ...
      {/* Panel izquierdo — branding (Se le agregó la clase css-panel-izquierdo) */}
      <div className="css-panel-izquierdo" style={{
        flex: "0 0 48%",
        display: "flex",
      ...
      {/* Panel derecho — formulario (Se agregó padding elástico para celulares) */}
      <div style={{
        flex: 1,
        display: "flex",
        flexDirection: "column",
        ...
        justifyContent: "center",
        background: "#111111",
        padding: "40px 24px", // Reducido un poco para dar más aire en pantallas móviles
        position: "relative",
        boxSizing: "border-box",
        width: "100%"
      }}>
        {/* Contenedor responsivo del logo que SOLO aparece en celulares */}
        <div className="logo-movil-solo" style={{ display: "none", marginBottom: 32, transform: "scale(0.95)" }}>
          <RapidimoLogo size="md" />
        </div>
      ...
      {/* Se corrigieron los selectores CSS de los Media Queries */}
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        /* Media Query arreglado conectando las clases correspondientes */
